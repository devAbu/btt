    ...
    if ($count > 0) {
        if (isset($_SESSION["email"])) {
            ...
            <ul class="list-group list-group-flush mr-5 mt-3" style=" border:none;float:right; margin-top:-100px; ">
                ...
                <li class="list-group-item " style="border:none">
                    <input class="btn btn-primary " value="Leave feedback " style="width:150px;color:white " data-toggle="collapse" data-target="#apartmentFeedbackCollapse' . $row["ID"] . '" id="apartmentFeedback' . $row["ID"] . '" />
                </li>
            </ul>

            <div class="collapse mt-4 feedCollapse" id="apartmentFeedbackCollapse' . $row["ID"] . '">
                ...
                <input type="button" class="btn btn-success mt-3" value="Send" id="apartmentFeedbackSend' . $row["ID"] . '" >         
            </div>
 ...
 <script>
    ...
    <script>
        function feed(id){
            ...
            $("#apartmentFeedbackSend"+idBut).click(function(){
                console.log(idBut)
                console.log(feedback)
                ...
                if(feedback == ""){
                    ...
                    $.ajax({
                        url: "dbSend/apartmentFeedback.php?task=sendFeed&idRes="+idBut+"&feedback="+feedback+"&session="+session,
